...
CONFIG = {
    ...
    "policy_type": "table",
    "table_size": "large",
    "has_query_index": True,   # V06: Querying indexed o_totalprice
    "has_policy_index": False, # V06: Policy predicate o_clerk IS UNINDEXED
    ...
    with conn.cursor() as cur:
        with open(filename, "w") as f:
            ...
            for access_type, key in test_cases.items():
                ...
                # 1. Execute query to record the output
